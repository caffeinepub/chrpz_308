...
import { ArrowLeft, CheckCircle, Copy, User, Wallet } from "lucide-react";
          ...
          <>
            ...
            <Card className="glass-dark border-2 border-primary/30">
              <CardHeader>
                ...
                <CardDescription>
                  Your Internet Computer wallet details
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {wallet ? (
                  ...
                  <Alert>
                    <AlertDescription>
                      Wallet not found. Your ICP wallet is automatically created

 ...
 */
export async function principalToAccountId(principal: Principal | string, subAccount?: Uint8Array): Promise<string> {
  try {
 ...
 */
export async function ensureValidAccountId(accountId: string, principal: Principal | string): Promise<string> {

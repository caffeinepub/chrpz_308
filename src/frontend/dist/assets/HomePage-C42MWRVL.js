import { r as reactExports, j as jsxRuntimeExports, u as useInternetIdentity, a as ue } from "./index-Ddz31US6.js";
import { c as createLucideIcon, u as useGetPosts, a as useIsAdmin, b as useCreatePost, d as useDeletePost, e as useFlagPost, f as useRegisterOrGetUser, L as Layout, F as Flag, B as Button, t as truncatePrincipal, g as formatRelativeTime } from "./Layout-CElxFZWf.js";
import { S as Skeleton, B as Badge, T as Trash2, C as CircleAlert } from "./skeleton-D2zI2eTD.js";
...
function HomePage() {
  ...
  const [showCompose, setShowCompose] = reactExports.useState(false);
  ...
  const handleFlag = async (postId) => {
    try {
      ...
      ue.success("Post flagged for review.");
    } catch {
      ue.error("Failed to flag post.");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        "data-ocid": "login-cta",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "w-10 h-10 text-primary mx-auto mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground mb-1", children: "Welcome to Chrpz" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-4", children: "A patriotic social platform built on the Internet Computer." }),
    ...
    isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-5", children: !showCompose ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 justify-end", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: createPost.isPending ? "Publishing..." : "Publish"
              }
            )
          ] })
        ]
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "feed-loading", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-card border border-border rounded-lg p-4 space-y-3",
        children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "w-12 h-12 mx-auto mb-3 opacity-30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No posts yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Be the first to share something!" })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "feed-list", children: posts.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      PostCard,
      {
        post,
        index: i,
        isAdmin: !!isAdmin,
        currentPrincipal: identity == null ? void 0 : identity.getPrincipal().toString(),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-secondary/10 border border-secondary/20 flex items-center justify-center text-secondary font-bold text-sm", children: (post.authorName || "U").charAt(0).toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground", children: post.authorName || truncatePrincipal(post.authorId) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: formatRelativeTime(post.createdAt) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            post.flagged && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "text-xs", children: "Flagged" }),
            (isAdmin || isOwner) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            isAdmin && !post.flagged && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                "data-ocid": "post-flag",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-3.5 h-3.5" })
              }
            )
          ] })
        ] }),
